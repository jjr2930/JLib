...
namespace JLib
{
    public class PoolData
    {
        ...
        public PoolData(UnityEngine.Object obj, bool IsInPool)
        {
            this.obj = obj;
    ...
    public class BasePoolManager : MonoSingle<BasePoolManager>
    {
        ...
        static UnityEngine.Object GetObject(string resourceName)
        {
        ...
        static void ReturnObject(string resourceName, Object obj)
        {
            List<PoolData> foundedList = null;
            bool success = false;
            if( Instance.unityObjectPool.TryGetValue( resourceName , out foundedList ))
